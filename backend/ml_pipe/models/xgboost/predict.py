...
def get_feature_names():
    ...
    names = [
        ...
        "Average Duration of All Roles",
        "Number of Industry Changes",
        "Number of Role Changes",
        "Total Number of Industries Worked In",
        "Total Number of Roles Held",
        "Days in Primary Industry",
        "Days in Secondary Industry",
        "Days in Tertiary Industry",
        "Highest Job Level Held",
    ]
    return names
...
def get_feature_description(name):
    descriptions = {
        ...
        "Current Job Level": "Level of the current position.",
        "Age Group": "Age group of the candidate.",
        "Current Job Role": "Numerical encoding of the current position.",
        "Current Industry": "Numerical encoding of the current position's industry.",
        "Time in Current Role": "Duration in the current position.",
        "Average Duration of All Roles": "Average duration across all positions.",
        "Number of Industry Changes": "Number of industry changes in the career.",
        "Number of Role Changes": "Number of position title changes in the career.",
        "Total Number of Industries Worked In": "Number of unique industries in the career.",
        "Total Number of Roles Held": "Number of unique position titles in the career.",
        "Days in Primary Industry": "Days spent in the most frequent industry.",
        "Days in Secondary Industry": "Days spent in the second most frequent industry.",
        "Days in Tertiary Industry": "Days spent in the third most frequent industry.",
        "Highest Job Level Held": "Highest position level achieved in the career."
    }
