...
def is_valid_sequence(seq_features):
    '''
    Prüft, ob alle Karrierestationen gültige Werte haben
    '''
...
def import_candidates_from_csv(csv_file):
    '''
    Importiert Kandidaten aus einer CSV-Datei in die MongoDB.
    '''
    try:
        mongo = MongoDb()
        ...
        try:
            ...
            for profile_id in profile_ids:
                if profile_id is None:
                    continue
                result = mongo.get({'_id': profile_id}, 'training_data2')
