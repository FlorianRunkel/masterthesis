...
class DataModule(LightningDataModule):
    ...
    def setup(self, stage=None):
        if self.train_data is None:
            ...
            train_features, train_labels = fe.extract_sequences_by_profile(raw_data[:train_size])
            val_features, val_labels = fe.extract_sequences_by_profile(raw_data[train_size:train_size + val_size])
            test_features, test_labels = fe.extract_sequences_by_profile(raw_data[train_size + val_size:])
